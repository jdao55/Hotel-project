...
class Room(models.Model):
    ...
    hotel = models.ForeignKey(Hotel, on_delete=models.CASCADE, to_field='hotel_id')
...
class Reservation(models.Model):
    ...
    room = models.ForeignKey(Room, on_delete=models.CASCADE, to_field='room_id')
...
class ParkingSpace(models.Model):
    ...
    parking_lot = models.ForeignKey(ParkingLot, on_delete=models.CASCADE, to_field='parking_lot_id')
    customer = models.ForeignKey(Customer, on_delete=models.SET_NULL, to_field='customer_id',blank=True,null=True)
    room = models.ForeignKey(Room, on_delete=models.SET_NULL, to_field='room_id',blank=True,null=True)
